...
def parse_args():
    ...
    parser.add_argument('--compression_targets', default='0.3,0.5,0.7',  type=str)
...
def train(num_episode, agent, env, output):
    ...
    while episode < num_episode:  # counting based on episode
        ...
        if done:  # end of episode
            print('#{}: episode_reward:{:.4f} acc: {:.4f}, ratio: {:.4f},strategy: {},d_prime: {}'.format(episode, episode_reward,
                                                                                 info['accuracy'],
